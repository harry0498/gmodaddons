...
function ENT:Draw()
	...
	cam.Start3D2D(pos + ang:Right() * -8 + ang:Forward() * -11 - ang:Up() * -10.5, ang, 0.01)
	...
	draw.SimpleText(math.Round((self:GetBatteryAmount() / 300) * 100) .. "%", "MoneyFont", 400, 400, Color(255, 255, 255), 1, 1)
	...
	cam.Start3D2D(pos + ang:Right() * -8 + ang:Forward() * -9 + ang:Up() * -8.8, ang2, 0.01)
